...
#
# Script generated by Vivado on Mon Aug 14 00:01:06 -03 2023
# SW Build 3865809 on Sun May  7 15:04:56 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : cordic_test.sh
...
#
# Usage        : cordic_test.sh
#                cordic_test.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                cordic_test.sh [-reset_run]
#                cordic_test.sh [-reset_log]
#                cordic_test.sh [-help]
#
...
#                script (type 'cordic_test.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname axi_infrastructure_v1_1_0 -libname axi_vip_v1_1_14 -libname processing_system7_vip_v1_0_16 -libname xil_defaultlib -libname generic_baseblocks_v2_1_0 -libname fifo_generator_v13_2_8 -libname axi_data_fifo_v2_1_27 -libname axi_register_slice_v2_1_28 -libname axi_protocol_converter_v2_1_28 -libname lib_cdc_v1_0_2 -libname proc_sys_reset_v5_0_13 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm axi_infrastructure_v1_1_0 axi_vip_v1_1_14 processing_system7_vip_v1_0_16 xil_defaultlib generic_baseblocks_v2_1_0 fifo_generator_v13_2_8 axi_data_fifo_v2_1_27 axi_register_slice_v2_1_28 axi_protocol_converter_v2_1_28 lib_cdc_v1_0_2 proc_sys_reset_v5_0_13)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "cordic_test.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./cordic_test.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"$ref_dir/../../../../testing_coordic_alg.gen/sources_1/bd/cordic_test/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../testing_coordic_alg.gen/sources_1/bd/cordic_test/ipshared/aed8/hdl" +incdir+"../../../../testing_coordic_alg.gen/sources_1/bd/cordic_test/ipshared/ec67/hdl" +incdir+"../../../../testing_coordic_alg.gen/sources_1/bd/cordic_test/ipshared/aed8/hdl" +incdir+"../../../../testing_coordic_alg.gen/sources_1/bd/cordic_test/ipshared/1b7e/hdl/verilog" +incdir+"../../../../testing_coordic_alg.gen/sources_1/bd/cordic_test/ipshared/122e/hdl/verilog" +incdir+"../../../../testing_coordic_alg.gen/sources_1/bd/cordic_test/ipshared/affe/hdl/verilog" +incdir+"../../../../testing_coordic_alg.gen/sources_1/bd/cordic_test/ipshared/20d0/hdl/verilog" +incdir+"/tools/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.cordic_test xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.cordic_test -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log cordic_test_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./cordic_test.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: cordic_test.sh [-help]\n\
Usage: cordic_test.sh [-step]\n\
Usage: cordic_test.sh [-lib_map_path]\n\
Usage: cordic_test.sh [-reset_run]\n\
Usage: cordic_test.sh [-reset_log]\n\
Usage: cordic_test.sh [-keep_index]\n\
Usage: cordic_test.sh [-noclean_files]\n\n\
